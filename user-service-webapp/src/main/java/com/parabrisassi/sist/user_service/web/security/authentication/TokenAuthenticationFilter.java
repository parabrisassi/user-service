...
import static com.parabrisassi.sist.user_service.web.security.authentication.AuthenticationConstants.AUTHENTICATION_HEADER;
import static com.parabrisassi.sist.user_service.web.security.authentication.AuthenticationConstants.AUTHENTICATION_SCHEME;
...
public class TokenAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    /**
     * A {@link RequestMatcher} that will tell if a request does not require token authentication.
     */
     ...
     *                                                matching endpoints in which token authentication is not required.
     */
    public TokenAuthenticationFilter(RequestMatcher passwordAuthenticationEndpoint,
                                     RequestMatcher tokenValidationEndpoint,
        ...
        Assert.notNull(tokenAuthenticationFailureHandler, "A token validation endpoint matcher must be set");
        ...
        optionalAuthenticationEndpointsMatchers.add(tokenValidationEndpoint);
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
        ...
        return getAuthenticationManager().authenticate(new RawAuthenticationToken(rawToken));
    }
